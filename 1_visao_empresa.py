...
csv_file_path = os.path.join(script_dir, "../Dataset/train.csv")
logo_file_path = os.path.join(script_dir, "../Pages/logo.png")  # Substitua pelo caminho absoluto do arquivo logo.png
